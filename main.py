...
import random
import math
from src.settings import SCREEN_WIDTH, SCREEN_HEIGHT, FPS, BG_COLOR, WHITE, TILE_SIZE, GRID_WIDTH, GRID_HEIGHT, \
    ENEMY_LOSE_INTEREST_TIME, ENEMY_TYPES, WEAPONS
from src.player import Player
from src.enemy import Enemy
from src.obstacle import Obstacle
from src.hiding_spot import HidingSpot
from src.ui import draw_menu, draw_game_over, draw_victory, draw_controls_help, draw_player_bars, draw_game_ui
...
def main():
    ...
    while running:
        ...
        if game_state == "MENU":
            ...
            draw_game_ui(screen, player, enemies, keys, WEAPONS)
